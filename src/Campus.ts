...
class Camper {
    ...
    constructor(
        ...
        public centroEntrenamiento: string
    ...
    validacionContratar(estadoRuta:boolean){
        if (estadoRuta === true) {
...
class Contrato {
    ...
    constructor(
        ...
        public tipo : string,
        public fecha: string,
        private _empresaContratante: string,
        private _tipoContrato: string
    ){}

    //todo -- Empresa Contratante

    set empresaContratante(empresaContratante:string){
        this._empresaContratante = empresaContratante;
    }

    get empresaContratante():string{
...
class Nivel {
    ...
    constructor(
        ...
        private _cantidadEstudiantes: number
    ){}

    //todo -- Cantidad De Estudiantes

    set cantidadEstudiantes(cantidadEstudiantes:number){
...
class Centro {
    ...
    constructor(
        ...
        private _cantidadCampers: number,

    ){}

    //todo -- CantidadCampers

    set cantidadCampers(cantidadCampers:number){
        this._cantidadCampers = cantidadCampers;
    }

    get cantidadCampers():number{
